  ...
  return (
    <div className="min-h-screen bg-[#0f0f1a] text-slate-200">
      ...
      <div className="px-4 pb-16 max-w-5xl mx-auto space-y-10">
        ...
        <DemoSection
          title="Music Player"
          description="Large glass panel mimicking Apple Music's Liquid Glass aesthetic."
          controls={<>
        ...
        >
          <LiquidSurface profile="convex" fidelity="high" scale={mpScale} bezelRatio={mpBezel} ior={mpIor}
            borderRadius={24} width={480} height={200} specular={mpSpec}
            ...
            <div className="flex items-center gap-5 z-10">
              ...
              <div className="flex flex-col gap-0.5">
                <span className="text-white/90 text-lg font-bold drop-shadow-sm">Liquid Dreams</span>
                <span className="text-white/50 text-sm font-medium">CSS &amp; SVG Audio</span>
                <div className="w-40 h-1 bg-white/10 rounded-full mt-2 overflow-hidden">
                  <div className="h-full w-[45%] bg-white/40 rounded-full" />
                </div>
              </div>
            </div>
            <div className="z-10 w-12 h-12 rounded-full bg-white/15 border border-white/30 flex items-center justify-center cursor-pointer hover:bg-white/25 transition-colors shrink-0">
